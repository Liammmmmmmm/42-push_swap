...
SRCS     = push_swap.c args.c maths.c  \
		   ...
		   sort/first_sort.c sort/utils.c sort/sort.c sort/controls.c sort/radix.c sort/mysort.c sort/mysort_utils.c sort/bubble.c sort/bbegsort.c sort/basics_a.c sort/basics_b.c
